...
const validationCandidates = [
  ...
  {id:'kathasaudham',title:'Kathasaudham · Parts 1–2',author:'Ambadi Narayana Poduval',language:'Malayalam',date:'1923 · reported edition',kind:'Story collection',hook:'Discover an early Malayalam story collection and choose which of its pieces interests you.',status:'Contents, edition and complete text need validation'},
  {id:'naalu-kathakal',title:'Naalu Kathakal',author:'Oduvil Kunhikrishna Menon',language:'Malayalam',date:'Edition date unverified',kind:'Four-story collection',hook:'Four stories in one collection offer a compact introduction to early Malayalam fiction.',status:'Publication date, contents and text need validation'},
      ...
      <main>
        ...
        <section className="discover" id="discover">
          ...
          <div className="story-grid">
            {(filter === "All" || filter === "Malayalam") && ["ദ്വാരക","Dwaraka","Vengayil Kunhiraman Nayanar","Malayalam"].join(" ").toLowerCase().includes(query.toLowerCase()) && <article className="story-card"><div className="story-card__body"><div className="eyebrow">Malayalam · Historical short story</div><h3>ദ്വാരക · Dwaraka</h3><p><strong>Vengayil Kunhiraman Nayanar</strong> · 1893</p><p><strong>Why explore:</strong> Discover an early Malayalam prose work and its historical literary context.</p><div className="candidate-tags"><span>Original Malayalam · source reader</span><span>English pending</span></div><div className="story-card__footer"><span>Source text</span><button onClick={() => openHistorical()}>Explore story <ArrowRight size={17}/></button></div></div></article>}
