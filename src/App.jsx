...
function App() {
  ...
  const openHistorical = async (selection = null, chapter = 1) => {
    ...
    try {
      ...
      if (paragraphs.length < 2) throw new Error('Source text could not be confirmed')
